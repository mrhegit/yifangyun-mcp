...
export const ItemRefSchema = z.string().trim().regex(BoundItemRefPattern).describe("Context-bound item ref returned by this server. Copy it exactly; beta.6 numeric refs are invalid.");
